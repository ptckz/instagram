package com.instagram.authservice.endpoint;
...
import com.instagram.authservice.exception.BadRequestException;
import com.instagram.authservice.exception.EmailAlreadyExistsException;
import com.instagram.authservice.exception.ResourceNotFoundException;
import com.instagram.authservice.exception.UsernameAlreadyExistsException;
import com.instagram.authservice.model.InstaUserDetails;
import com.instagram.authservice.model.Profile;
import com.instagram.authservice.model.User;
import com.instagram.authservice.payload.ApiResponse;
import com.instagram.authservice.payload.JwtAuthenticationResponse;
import com.instagram.authservice.payload.LoginRequest;
import com.instagram.authservice.payload.SignUpRequest;
import com.instagram.authservice.payload.UserSummary;
import com.instagram.authservice.service.JwtTokenProvider;
import com.instagram.authservice.service.UserService;
